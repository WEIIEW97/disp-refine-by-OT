...
struct device_buffer {
  ...
  void upload(const void* h_data) {
    cudaMemcpy(data, h_data, size, cudaMemcpyHostToDevice);
  }
  void download(void* h_data) {
...
void colorize_disparity(const cv::Mat& src, cv::Mat& dst, int disp_size,
